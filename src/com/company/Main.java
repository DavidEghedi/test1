...
public class Main {
    ...
    public static void addActionToSubmitButton(JPanel panel, Question question) {
    ...
    public static void addActionToNextButton(JPanel panel, Question question) {
    ...
    private static void askNextQuestion(JPanel panel, Question question) {
        panel.removeAll();
        questionNumber++;
    ...
    private static void mustSelectOneOptionError(JPanel panel, Question question) {
    ...
    private static void addNextQuestionButton(JPanel panel, Question question) {
    ...
    private static void addTheButtonThatComesNext(JPanel panel, Question question) {
        if (questionNumber == TOTAL_QUESTIONS_NUMBER)
            addFinishButton(panel);
        else
    ...
    private static void wrongAnswer(JPanel panel, Question question) {
        JLabel label;
    ...
    private static void rightAnswer(JPanel panel, Question question) {
        rightAnswers++;
    ...
    private static boolean answerIsRight(String answer, Question question) {
    ...
    private static JPanel buildPanel(Question question) {
    ...
    private static void placeComponents(JPanel panel, Question question) {
        panel.removeAll();
